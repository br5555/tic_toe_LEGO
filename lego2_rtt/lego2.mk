...
# Autogenerated on: 08-Jun-2016 11:55:53
# Model: LEGO2
# File name: lego2.mk
# Template: gmake 
...
MATLAB_ROOT_RELATIVE := ..\..\..\..\..\Program Files\MATLAB\R2016a\#MATLAB_ROOT_RELATIVE_END
MATLAB_ROOT_ABSOLUTE := C:\Program Files\MATLAB\R2016a\#MATLAB_ROOT_ABSOLUTE_END
...
COMPILER_CODEGEN_ARGS := -I"C:/MATLAB/SupportPackages/R2016a/toolbox/realtime/targets/lego/include" -I"C:/Program Files/MATLAB/R2016a/simulink/include/sf_runtime" -I"C:/Users/Lovro/Downloads/tictactoe_final/lego2_rtt" -I"C:/Users/Lovro/Downloads/tictactoe_final" -I"C:/Program Files/MATLAB/R2016a/extern/include" -I"C:/Program Files/MATLAB/R2016a/simulink/include" -I"C:/Program Files/MATLAB/R2016a/rtw/c/src" -I"C:/Program Files/MATLAB/R2016a/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/R2016a/rtw/c/ert" -I"C:/Program Files/MATLAB/R2016a/toolbox/coder/rtiostream/src/utils" -I"C:/Program Files/MATLAB/R2016a/rtw/c/src/ext_mode/serial" -I"C:/MATLAB/SupportPackages/R2016a/toolbox/realtime/targets/lego/src"  -D"MODEL=lego2"  -D"NUMST=2"  -D"NCSTATES=3"  -D"HAVESTDIO="  -D"ON_TARGET_WAIT_FOR_START=1"  -D"ONESTEPFCN=0"  -D"EXT_MODE=1"  -D"TERMFCN=1"  -D"MAT_FILE=0"  -D"MULTI_INSTANCE_CODE=0"  -D"INTEGER_CODE=0"  -D"MT=0"  -D"CLASSIC_INTERFACE=0"  -D"ALLOCATIONFCN=0"  -D"TID01EQ=1"  -D"EXIT_FAILURE=1"  -D"EXTMODE_DISABLEPRINTF="  -D"EXTMODE_DISABLETESTING="  -D"EXTMODE_DISABLE_ARGS_PROCESSING=1" 

COMPILER_TCCFG_ARGS := -c -ffreestanding -fsigned-char -mcpu=arm7tdmi -Os -Winline -Wall -Werror-implicit-function-declaration --param max-inline-insns-single=1000 -mthumb -mthumb-interwork -ffunction-sections -fdata-sections -nostdinc -iquote"C:/MATLAB/SupportPackages/R2016a/nxtOSEK/lejos_nxj/src/nxtvm/javavm" -iquote"C:/MATLAB/SupportPackages/R2016a/nxtOSEK/lejos_nxj/src/nxtvm/platform/nxt" -iquote"C:/MATLAB/SupportPackages/R2016a/nxtOSEK/ecrobot/bios" -iquote"C:/MATLAB/SupportPackages/R2016a/nxtOSEK/ecrobot/c" -iquote"C:/MATLAB/SupportPackages/R2016a/nxtOSEK/c++" -I. -I"C:/MATLAB/SupportPackages/R2016a/nxtOSEK/toppers_osek/kernel" -I"C:/MATLAB/SupportPackages/R2016a/nxtOSEK/toppers_osek/include" -I"C:/MATLAB/SupportPackages/R2016a/nxtOSEK/toppers_osek/config/at91sam7s-gnu" -I"C:/MATLAB/SupportPackages/R2016a/nxtOSEK/toppers_osek/config/at91sam7s-gnu/lego_nxt" -I"C:/MATLAB/SupportPackages/R2016a/nxtOSEK/toppers_osek/syslib/at91sam7s-gnu/lego_nxt" -I"C:/MATLAB/SupportPackages/R2016a/GNU_Tools_ARM_Embedded/lib/gcc/arm-none-eabi/4.8.3/include" -I"C:/MATLAB/SupportPackages/R2016a/GNU_Tools_ARM_Embedded/lib/gcc/arm-none-eabi/4.8.3/include-fixed" -I"C:/MATLAB/SupportPackages/R2016a/GNU_Tools_ARM_Embedded/arm-none-eabi/include" -DLEGO -std=gnu99
COMPILER_ARGS := $(COMPILER_CODEGEN_ARGS) $(COMPILER_TCCFG_ARGS)

LINKER_CODEGEN_ARGS := 

LINKER_TCCFG_ARGS := -nostartfiles -o $(TARGET) -T ./mine.ld -mthumb -mthumb-interwork -Wl,--allow-multiple-definition  -Wl,--gc-sections -L"C:/MATLAB/SupportPackages/R2016a/nxtOSEK/ecrobot" -L"C:/MATLAB/SupportPackages/R2016a/nxtOSEK/c++" -Wl,--start-group -lgcc -lc -lc -lm -lnosys -Wl,--end-group -lm -llejososek -lecrobot
...
COMPILER ?= $(subst \,/,C:\MATLAB\SupportPackages\R2016a\GNU_Tools_ARM_Embedded\bin\arm-none-eabi-gcc)

LINKER ?= $(subst \,/,C:\MATLAB\SupportPackages\R2016a\GNU_Tools_ARM_Embedded\bin\arm-none-eabi-g++)

PREBUILD_TOOL ?= 

POSTBUILD_TOOL ?= $(subst \,/,C:\MATLAB\SupportPackages\R2016a\GNU_Tools_ARM_Embedded\bin\arm-none-eabi-objcopy)
